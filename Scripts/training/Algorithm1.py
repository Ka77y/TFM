...
def relevanceFirstTopicSolution(main_doc_response, list_docs_high):
    ...
    first_doc_result_topics = gf.obtainArrayDocTopics(first_doc_result_response);
            ...
            try:
                ...
                for j in range(0,3):
                    ...
                    if find_topic == 0:
                        ...
                        #creación de regla
                        gf.createRulesCSV("relevance_1", str(main_doc_topics[i_rank]), "put", str(topic))
                        break
...
def replaceTopicWhenItExists(i_rank, main_doc_topics, main_doc_response, topic_high_document=0):
    ...
    for x in range(i_rank, len(main_doc_topics)):
        ...
        break
    #asocia tópicos
    gf.createRulesCSV("relevance_1", next_augmented_topic, "move", topic_high_document, i_rank)
